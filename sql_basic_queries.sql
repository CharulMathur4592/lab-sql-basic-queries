...
-- 1. Display all the tables of the database
SHOW TABLES;	
...
SELECT COUNT(*) AS films_cuurently_rented
FROM sakila.rental
WHERE rental_date IS NULL AND rental_date IS NOT NULL;
...
SELECT COUNT(*) AS film_with_behind_the_scenes
FROM sakila.film
